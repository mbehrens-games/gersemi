...
enum
{
  PATCH_PORT_ARP_MODE_PORTAMENTO = 1, 
  PATCH_PORT_ARP_MODE_GLISSANDO, 
  PATCH_PORT_ARP_MODE_ARPEGGIO, 
  PATCH_PORT_ARP_MODE_ROLLED 
};

enum
{
  PATCH_PORT_ARP_DIRECTION_UP = 1, 
  PATCH_PORT_ARP_DIRECTION_DOWN, 
  PATCH_PORT_ARP_DIRECTION_UP_AND_DOWN, 
  PATCH_PORT_ARP_DIRECTION_DOWN_AND_UP 
};
...
#define PATCH_ENV_KEYSCALE_DEFAULT      1
#define PATCH_ENV_KEYSCALE_LOWER_BOUND  1
#define PATCH_ENV_KEYSCALE_UPPER_BOUND  4
...
#define PATCH_LFO_WAVEFORM_UPPER_BOUND  PATCH_LFO_WAVEFORM_NOISE
...
#define PATCH_LFO_QUANTIZE_DEFAULT      0
#define PATCH_LFO_QUANTIZE_LOWER_BOUND  0
#define PATCH_LFO_QUANTIZE_UPPER_BOUND  16
#define PATCH_LFO_QUANTIZE_NUM_VALUES   (PATCH_LFO_QUANTIZE_UPPER_BOUND - PATCH_LFO_QUANTIZE_LOWER_BOUND + 1)

#define PATCH_LFO_SAH_NOISE_DEFAULT     0
#define PATCH_LFO_SAH_NOISE_LOWER_BOUND 0
#define PATCH_LFO_SAH_NOISE_UPPER_BOUND 32
#define PATCH_LFO_SAH_NOISE_NUM_VALUES  (PATCH_LFO_SAH_NOISE_UPPER_BOUND - PATCH_LFO_SAH_NOISE_LOWER_BOUND + 1)
...
/* portamento / arpeggio */
#define PATCH_PORT_ARP_MODE_DEFAULT       PATCH_PORT_ARP_MODE_PORTAMENTO
#define PATCH_PORT_ARP_MODE_LOWER_BOUND   PATCH_PORT_ARP_MODE_PORTAMENTO
#define PATCH_PORT_ARP_MODE_UPPER_BOUND   PATCH_PORT_ARP_MODE_ROLLED
#define PATCH_PORT_ARP_MODE_NUM_VALUES    (PATCH_PORT_ARP_MODE_UPPER_BOUND - PATCH_PORT_ARP_MODE_LOWER_BOUND + 1)

#define PATCH_PORT_ARP_DIRECTION_DEFAULT      PATCH_PORT_ARP_DIRECTION_UP
#define PATCH_PORT_ARP_DIRECTION_LOWER_BOUND  PATCH_PORT_ARP_DIRECTION_UP
#define PATCH_PORT_ARP_DIRECTION_UPPER_BOUND  PATCH_PORT_ARP_DIRECTION_DOWN_AND_UP
#define PATCH_PORT_ARP_DIRECTION_NUM_VALUES   (PATCH_PORT_ARP_DIRECTION_UPPER_BOUND - PATCH_PORT_ARP_DIRECTION_LOWER_BOUND + 1)

#define PATCH_PORT_ARP_SPEED_DEFAULT      1
#define PATCH_PORT_ARP_SPEED_LOWER_BOUND  1
#define PATCH_PORT_ARP_SPEED_UPPER_BOUND  16
#define PATCH_PORT_ARP_SPEED_NUM_VALUES   (PATCH_PORT_ARP_SPEED_UPPER_BOUND - PATCH_PORT_ARP_SPEED_LOWER_BOUND + 1)
