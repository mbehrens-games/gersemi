...
enum
{
  PATCH_ARPEGGIO_PATTERN_UP = 1, 
  PATCH_ARPEGGIO_PATTERN_DOWN, 
  PATCH_ARPEGGIO_PATTERN_UP_AND_DOWN, 
  PATCH_ARPEGGIO_PATTERN_DOWN_AND_UP, 
  PATCH_ARPEGGIO_PATTERN_UP_AND_DOWN_ALTERNATE, 
  PATCH_ARPEGGIO_PATTERN_DOWN_AND_UP_ALTERNATE 
};
...
#define PATCH_CART_NAME_SIZE  (12 + 1)
#define PATCH_PATCH_NAME_SIZE (12 + 1)
...
#define PATCH_ARPEGGIO_PATTERN_UPPER_BOUND  PATCH_ARPEGGIO_PATTERN_DOWN_AND_UP_ALTERNATE
