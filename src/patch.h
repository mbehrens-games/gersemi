...
enum
{
  PATCH_KEY_FOLLOW_MODE_KEY = 0, 
  PATCH_KEY_FOLLOW_MODE_NOTE 
};

enum
{
  PATCH_SYNC_OSC_OFF = 0, 
  PATCH_SYNC_OSC_ON 
};
...
#define PATCH_PEDAL_ADJUST_LOWER_BOUND   -8
#define PATCH_PEDAL_ADJUST_UPPER_BOUND    0
...
/* key follow */
#define PATCH_KEY_FOLLOW_MODE_DEFAULT       PATCH_KEY_FOLLOW_MODE_NOTE
#define PATCH_KEY_FOLLOW_MODE_LOWER_BOUND   PATCH_KEY_FOLLOW_MODE_KEY
#define PATCH_KEY_FOLLOW_MODE_UPPER_BOUND   PATCH_KEY_FOLLOW_MODE_NOTE
#define PATCH_KEY_FOLLOW_MODE_NUM_VALUES    (PATCH_KEY_FOLLOW_MODE_UPPER_BOUND - PATCH_KEY_FOLLOW_MODE_LOWER_BOUND + 1)
...
/* sync */
#define PATCH_SYNC_OSC_DEFAULT      PATCH_SYNC_OSC_ON
#define PATCH_SYNC_OSC_LOWER_BOUND  PATCH_SYNC_OSC_OFF
#define PATCH_SYNC_OSC_UPPER_BOUND  PATCH_SYNC_OSC_ON
#define PATCH_SYNC_OSC_NUM_VALUES   (PATCH_SYNC_OSC_UPPER_BOUND - PATCH_SYNC_OSC_LOWER_BOUND + 1)

#define PATCH_SYNC_LFO_DEFAULT      PATCH_SYNC_LFO_ON
#define PATCH_SYNC_LFO_LOWER_BOUND  PATCH_SYNC_LFO_OFF
#define PATCH_SYNC_LFO_UPPER_BOUND  PATCH_SYNC_LFO_ON
