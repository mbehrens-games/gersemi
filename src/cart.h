...
enum
{
  ...
  PATCH_OSC_WAVEFORM_VAL_SQUARE, 
  PATCH_OSC_WAVEFORM_VAL_AP_SQUARE, 
  PATCH_OSC_WAVEFORM_VAL_SAW, 
  PATCH_OSC_WAVEFORM_VAL_AP_SAW, 
  PATCH_OSC_WAVEFORM_VAL_DRIVE_SAW, 
  PATCH_OSC_WAVEFORM_VAL_WRAP_SAW, 
  PATCH_OSC_WAVEFORM_VAL_TRI, 
  PATCH_OSC_WAVEFORM_VAL_AP_TRI, 
  PATCH_OSC_WAVEFORM_VAL_DRIVE_TRI, 
  PATCH_OSC_WAVEFORM_VAL_FOLD_TRI, 
