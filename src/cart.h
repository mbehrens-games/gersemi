...
enum
{
  ...
  PATCH_OSC_WAVEFORM_VAL_ALT_SINE, 
  PATCH_OSC_WAVEFORM_VAL_ALT_FULL_SINE, 
  PATCH_OSC_WAVEFORM_VAL_SQUARE, 
  PATCH_OSC_WAVEFORM_VAL_SAW, 
  PATCH_OSC_WAVEFORM_VAL_TRI, 
  PATCH_OSC_WAVEFORM_VAL_ALT_SQUARE, 
  PATCH_OSC_WAVEFORM_VAL_ALT_SAW, 
  PATCH_OSC_WAVEFORM_VAL_ALT_TRI, 
