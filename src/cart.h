...
enum
{
  ...
  PATCH_ALGORITHM_VAL_2C_2_MOD_3, 
  PATCH_ALGORITHM_VAL_2C_1_MOD_3, 
  PATCH_ALGORITHM_VAL_2C_1_MOD_BOTH, 
...
enum
{
  ...
  PATCH_OSC_WAVEFORM_VAL_CURVY, 
  PATCH_OSC_WAVEFORM_VAL_SWAP, 
  PATCH_OSC_WAVEFORM_VAL_HALF_SINE, 
  PATCH_OSC_WAVEFORM_VAL_HALF_CURVY, 
  PATCH_OSC_WAVEFORM_VAL_FULL_SINE, 
  PATCH_OSC_WAVEFORM_VAL_FULL_CURVY, 
  PATCH_OSC_WAVEFORM_VAL_QUARTER_SINE, 
  PATCH_OSC_WAVEFORM_VAL_QUARTER_CURVY, 
  PATCH_OSC_WAVEFORM_VAL_AP_SINE, 
  PATCH_OSC_WAVEFORM_VAL_AP_CURVY, 
  PATCH_OSC_WAVEFORM_VAL_AP_SWAP, 
  PATCH_OSC_WAVEFORM_VAL_AP_FULL_SINE, 
  PATCH_OSC_WAVEFORM_VAL_AP_FULL_CURVY, 
  PATCH_OSC_WAVEFORM_VAL_DOUBLE_SINE, 
  PATCH_OSC_WAVEFORM_VAL_DOUBLE_CURVY, 
