...
#define BANK_VIBRATOS_PER_VOICE   1
#define BANK_TREMOLOS_PER_VOICE   1
#define BANK_LOWPASSES_PER_VOICE  1
#define BANK_HIGHPASSES_PER_VOICE 1
...
#define BANK_NUM_VIBRATOS     (BANK_NUM_VOICES * BANK_VIBRATOS_PER_VOICE)
#define BANK_NUM_TREMOLOS     (BANK_NUM_VOICES * BANK_TREMOLOS_PER_VOICE)
#define BANK_NUM_LOWPASSES    (BANK_NUM_VOICES * BANK_LOWPASSES_PER_VOICE)
#define BANK_NUM_HIGHPASSES   (BANK_NUM_VOICES * BANK_HIGHPASSES_PER_VOICE)
