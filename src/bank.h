...
#define BANK_AMPLITUDE_ENVELOPES_PER_VOICE  1
#define BANK_FILTER_ENVELOPES_PER_VOICE     1
#define BANK_PITCH_ENVELOPES_PER_VOICE      1
#define BANK_LFOS_PER_VOICE                 1
#define BANK_LOWPASS_FILTERS_PER_VOICE      1
#define BANK_HIGHPASS_FILTERS_PER_VOICE     1

#define BANK_NUM_AMPLITUDE_ENVELOPES  (BANK_NUM_VOICES * BANK_AMPLITUDE_ENVELOPES_PER_VOICE)
#define BANK_NUM_FILTER_ENVELOPES     (BANK_NUM_VOICES * BANK_FILTER_ENVELOPES_PER_VOICE)
#define BANK_NUM_PITCH_ENVELOPES      (BANK_NUM_VOICES * BANK_PITCH_ENVELOPES_PER_VOICE)
...
#define BANK_BOOSTS_PER_INSTRUMENT      1
#define BANK_BENDERS_PER_INSTRUMENT     1
#define BANK_SWEEPS_PER_INSTRUMENT      1
#define BANK_ARPEGGIOS_PER_INSTRUMENT   1

#define BANK_NUM_BOOSTS     (BANK_NUM_INSTRUMENTS * BANK_BOOSTS_PER_INSTRUMENT)
#define BANK_NUM_BENDERS    (BANK_NUM_INSTRUMENTS * BANK_BENDERS_PER_INSTRUMENT)
