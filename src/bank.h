...
#define BANK_ENVELOPES_PER_VOICE        1
#define BANK_PEGS_PER_VOICE             3
...
enum
{
  BANK_PEG_INDEX_FILTER = 0, 
  BANK_PEG_INDEX_PITCH, 
  BANK_PEG_INDEX_EXTRA 
};

enum
{
  BANK_LFO_INDEX_LFO_1 = 0, 
  BANK_LFO_INDEX_LFO_2 
};
