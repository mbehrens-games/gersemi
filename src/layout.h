...
enum
{
  ...
  LAYOUT_CART_HEADER_LABEL_MOD_WHEEL, 
  LAYOUT_CART_HEADER_LABEL_AFTERTOUCH, 
  LAYOUT_CART_HEADER_LABEL_EXP_PEDAL, 
...
enum
{
  ...
  LAYOUT_CART_PARAM_LABEL_OSC_SYNC, 
  ...
  LAYOUT_CART_PARAM_LABEL_OSC_1_OCTAVE, 
  LAYOUT_CART_PARAM_LABEL_OSC_1_NOTE, 
  LAYOUT_CART_PARAM_LABEL_OSC_1_DETUNE, 
  LAYOUT_CART_PARAM_LABEL_OSC_1_ROUTING_VIBRATO, 
  LAYOUT_CART_PARAM_LABEL_OSC_1_ROUTING_PITCH_ENV, 
  LAYOUT_CART_PARAM_LABEL_OSC_1_ROUTING_PITCH_WHEEL, 
  ...
  LAYOUT_CART_PARAM_LABEL_OSC_2_OCTAVE, 
  LAYOUT_CART_PARAM_LABEL_OSC_2_NOTE, 
  LAYOUT_CART_PARAM_LABEL_OSC_2_DETUNE, 
  LAYOUT_CART_PARAM_LABEL_OSC_2_ROUTING_VIBRATO, 
  LAYOUT_CART_PARAM_LABEL_OSC_2_ROUTING_PITCH_ENV, 
  LAYOUT_CART_PARAM_LABEL_OSC_2_ROUTING_PITCH_WHEEL, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_WAVEFORM, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_PHI, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_FREQ_MODE, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_MULTIPLE, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_DIVISOR, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_OCTAVE, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_NOTE, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_DETUNE, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_ROUTING_VIBRATO, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_ROUTING_PITCH_ENV, 
  LAYOUT_CART_PARAM_LABEL_OSC_3_ROUTING_PITCH_WHEEL, 
  ...
  LAYOUT_CART_PARAM_LABEL_ENV_1_TRANSITION, 
  LAYOUT_CART_PARAM_LABEL_ENV_1_HOLD_MODE, 
  LAYOUT_CART_PARAM_LABEL_ENV_1_RATE_KS, 
  LAYOUT_CART_PARAM_LABEL_ENV_1_LEVEL_KS, 
  LAYOUT_CART_PARAM_LABEL_ENV_1_ROUTING_TREMOLO, 
  LAYOUT_CART_PARAM_LABEL_ENV_1_ROUTING_BOOST, 
  LAYOUT_CART_PARAM_LABEL_ENV_1_ROUTING_VELOCITY, 
  ...
  LAYOUT_CART_PARAM_LABEL_ENV_2_TRANSITION, 
  LAYOUT_CART_PARAM_LABEL_ENV_2_HOLD_MODE, 
  LAYOUT_CART_PARAM_LABEL_ENV_2_RATE_KS, 
  LAYOUT_CART_PARAM_LABEL_ENV_2_LEVEL_KS, 
  LAYOUT_CART_PARAM_LABEL_ENV_2_ROUTING_TREMOLO, 
  LAYOUT_CART_PARAM_LABEL_ENV_2_ROUTING_BOOST, 
  LAYOUT_CART_PARAM_LABEL_ENV_2_ROUTING_VELOCITY, 
  ...
  LAYOUT_CART_PARAM_LABEL_ENV_3_TRANSITION, 
  LAYOUT_CART_PARAM_LABEL_ENV_3_HOLD_MODE, 
  LAYOUT_CART_PARAM_LABEL_ENV_3_RATE_KS, 
  LAYOUT_CART_PARAM_LABEL_ENV_3_LEVEL_KS, 
  LAYOUT_CART_PARAM_LABEL_ENV_3_ROUTING_TREMOLO, 
  LAYOUT_CART_PARAM_LABEL_ENV_3_ROUTING_BOOST, 
  LAYOUT_CART_PARAM_LABEL_ENV_3_ROUTING_VELOCITY, 
  ...
  LAYOUT_CART_PARAM_LABEL_VIBRATO_SENSITIVITY, 
  LAYOUT_CART_PARAM_LABEL_VIBRATO_SYNC, 
  LAYOUT_CART_PARAM_LABEL_VIBRATO_POLARITY, 
  ...
  LAYOUT_CART_PARAM_LABEL_TREMOLO_SENSITIVITY, 
  LAYOUT_CART_PARAM_LABEL_TREMOLO_SYNC, 
  ...
  LAYOUT_CART_PARAM_LABEL_CHORUS_SENSITIVITY, 
  LAYOUT_CART_PARAM_LABEL_CHORUS_SYNC, 
  LAYOUT_CART_PARAM_LABEL_BOOST_SENSITIVITY, 
  LAYOUT_CART_PARAM_LABEL_VELOCITY_SENSITIVITY, 
...
#define LAYOUT_CART_ENV_1_TRANSITION_Y            LAYOUT_CART_COMPUTE_PARAM_Y(LAYOUT_CART_HEADER_ENV_1_Y, 5)
...
#define LAYOUT_CART_ENV_2_TRANSITION_Y            LAYOUT_CART_COMPUTE_PARAM_Y(LAYOUT_CART_HEADER_ENV_2_Y, 5)
...
#define LAYOUT_CART_ENV_3_TRANSITION_Y            LAYOUT_CART_COMPUTE_PARAM_Y(LAYOUT_CART_HEADER_ENV_3_Y, 5)
