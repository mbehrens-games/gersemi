...
enum
{
  ...
  LAYOUT_CART_PARAM_AUDITION_OCTAVE, 
  LAYOUT_CART_PARAM_AUDITION_VELOCITY, 
  LAYOUT_CART_PARAM_AUDITION_PITCH_WHEEL,
  LAYOUT_CART_PARAM_AUDITION_MOD_WHEEL, 
  LAYOUT_CART_PARAM_AUDITION_AFTERTOUCH, 
  LAYOUT_CART_PARAM_AUDITION_EXP_PEDAL, 
...
#define LAYOUT_CART_BUTTON_OR_TEXT_BOX_IS_IN_MAIN_AREA(pos_y)                       \
  ( (pos_y - 4 * 2 > LAYOUT_CART_MAIN_AREA_Y - 4 * LAYOUT_CART_MAIN_AREA_HEIGHT) && \
    (pos_y + 4 * 2 < LAYOUT_CART_MAIN_AREA_Y + 4 * LAYOUT_CART_MAIN_AREA_HEIGHT))

#define LAYOUT_CART_BUTTON_OR_TEXT_BOX_IS_NOT_IN_MAIN_AREA(pos_y)                   \
  (!(LAYOUT_CART_BUTTON_OR_TEXT_BOX_IS_IN_MAIN_AREA(pos_y)))
