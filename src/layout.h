...
#define LAYOUT_PARAM_SLIDER_TRACK_X     (4 * 8 + 0)
#define LAYOUT_PARAM_SLIDER_VALUE_WIDTH 4
#define LAYOUT_PARAM_SLIDER_TRACK_WIDTH 8

#define LAYOUT_PARAM_ARROWS_LEFT_X      (1 * 8 + 0)
#define LAYOUT_PARAM_ARROWS_VALUE_X     (2 * 8 + 4)
#define LAYOUT_PARAM_ARROWS_RIGHT_X     (11 * 8 + 0)
#define LAYOUT_PARAM_ARROWS_VALUE_WIDTH 8

#define LAYOUT_PARAM_RADIO_BUTTON_X     (1 * 8 + 4)
#define LAYOUT_PARAM_RADIO_VALUE_X      (4 * 8 + 0)
#define LAYOUT_PARAM_RADIO_VALUE_WIDTH  8

#if 0
/* values for narrows columns */
#define LAYOUT_PARAM_SLIDER_VALUE_X     (0 * 8 + 0)
