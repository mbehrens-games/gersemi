...
#define IMPORT_SBI_OPERATOR_OFFSET_MULTIPLE_FLAGS                              \
  (IMPORT_SBI_SHARED_BYTE_MODULATOR_MULTIPLE_FLAGS - IMPORT_SBI_SHARED_BYTE_MODULATOR_MULTIPLE_FLAGS)

#define IMPORT_SBI_OPERATOR_OFFSET_LEVEL_KEYSCALE_TOTAL_LEVEL                  \
  (IMPORT_SBI_SHARED_BYTE_MODULATOR_LEVEL_KEYSCALE_TOTAL_LEVEL - IMPORT_SBI_SHARED_BYTE_MODULATOR_MULTIPLE_FLAGS)

#define IMPORT_SBI_OPERATOR_OFFSET_ATTACK_RATE_DECAY_RATE                      \
  (IMPORT_SBI_SHARED_BYTE_MODULATOR_ATTACK_RATE_DECAY_RATE - IMPORT_SBI_SHARED_BYTE_MODULATOR_MULTIPLE_FLAGS)

#define IMPORT_SBI_OPERATOR_OFFSET_SUSTAIN_LEVEL_RELEASE_RATE                  \
  (IMPORT_SBI_SHARED_BYTE_MODULATOR_SUSTAIN_LEVEL_RELEASE_RATE - IMPORT_SBI_SHARED_BYTE_MODULATOR_MULTIPLE_FLAGS)

#define IMPORT_SBI_OPERATOR_OFFSET_WAVEFORM                                    \
  (IMPORT_SBI_SHARED_BYTE_MODULATOR_WAVEFORM - IMPORT_SBI_SHARED_BYTE_MODULATOR_MULTIPLE_FLAGS)

#define IMPORT_SBI_M1_OFFSET_FEEDBACK_ALGORITHM                                \
  (IMPORT_SBI_SHARED_BYTE_FEEDBACK_ALGORITHM - IMPORT_SBI_SHARED_BYTE_MODULATOR_MULTIPLE_FLAGS)

#define IMPORT_SBI_M2_OFFSET_ALGORITHM                                         \
  (IMPORT_SBI_4OP_EXTRA_BYTE_ALGORITHM - IMPORT_SBI_4OP_EXTRA_BYTE_MODULATOR_MULTIPLE_FLAGS)
